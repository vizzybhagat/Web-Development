                  ...
                  <?php
                      if(isset($_POST['add1']))
                      {
                        ...
                        else
                        {
                            ...
                            $sql = "INSERT INTO carts (name, item, price, quantity) VALUES ('name', 'Veg Manchurian', '150', '$qty1')";
                  ...
                  <?php
                      if(isset($_POST['add2']))
                      {
                        ...
                        else
                        {
                            ...
                            $sql = "INSERT INTO carts (name, item, price, quantity) VALUES ('name', 'Veg Crispy', '280', '$qty2')";
                            if(mysqli_query($link, $sql))
                            {
                                echo "Records added successfully.";
                            } 
                    ...
                    <?php
                        if(isset($_POST['del2']))
                      {
                        ...
                        {
                            $sql = "DELETE FROM carts WHERE item='Veg Crispy'";
                  ...
                  <?php
                      if(isset($_POST['add3']))
                      {
                        ...
                        else
                        {
                            ...
                            $sql = "INSERT INTO carts (name, item, price, quantity) VALUES ('name', 'Fried Rice', '225', '$qty3')";
                            if(mysqli_query($link, $sql))
                            {
                                echo "Records added successfully.";
                            } 
                    ...
                    <?php
                        if(isset($_POST['del3']))
                      {
                        ...
                        {
                            $sql = "DELETE FROM carts WHERE item='Fried Rice'";
                  ...
                  <?php
                      if(isset($_POST['add4']))
                      {
                        ...
                        else
                        {
                            ...
                            $sql = "INSERT INTO carts (name, item, price, quantity) VALUES ('name', 'Schezwan Rice', '270', '$qty4')";
                            if(mysqli_query($link, $sql))
                            {
                                echo "Records added successfully.";
                            } 
                    ...
                    <?php
                        if(isset($_POST['del4']))
                      {
                        ...
                        {
                            $sql = "DELETE FROM carts WHERE item='Schezwan Rice'";
                  ...
                  <?php
                      if(isset($_POST['add5']))
                      {
                        ...
                        else
                        {
                            ...
                            $sql = "INSERT INTO carts (name, item, price, quantity) VALUES ('name', 'Noodles', '250', '$qty5')";
                            if(mysqli_query($link, $sql))
                            {
                                echo "Records added successfully.";
                            } 
                    ...
                    <?php
                        if(isset($_POST['del5']))
                      {
                        ...
                        {
                            $sql = "DELETE FROM carts WHERE item='Noodles'";
                  ...
                  <?php
                      if(isset($_POST['add6']))
                      {
                        ...
                        else
                        {
                            ...
                            $sql = "INSERT INTO carts (name, item, price, quantity) VALUES ('name', 'Paneer Chilly', '270', '$qty6')";
                            if(mysqli_query($link, $sql))
                            {
                                echo "Records added successfully.";
                            } 
                    ...
                    <?php
                        if(isset($_POST['del6']))
                      {
                        ...
                        {
                            $sql = "DELETE FROM carts WHERE item='Paneer Chilly'";
