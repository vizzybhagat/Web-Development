                  ...
                  <?php
                      if(isset($_POST['add1']))
                      {
                        ...
                        else
                        {
                            ...
                            $sql = "INSERT INTO carts (name, item, price, quantity) VALUES ('name', 'Mini Burgers', '150', '$qty1')";
                    ...
                    <?php
                        if(isset($_POST['del1']))
                      {
                        ...
                        {
                            $sql = "DELETE FROM carts WHERE item='Mini Burgers'";
                  ...
                  <?php
                      if(isset($_POST['add2']))
                      {
                        ...
                        else
                        {
                            ...
                            $sql = "INSERT INTO carts (name, item, price, quantity) VALUES ('name', 'Mexican Salad', '80', '$qty2')";
                            if(mysqli_query($link, $sql))
                            {
                                echo "Records added successfully.";
                            } 
                    ...
                    <?php
                        if(isset($_POST['del2']))
                      {
                        ...
                        {
                            $sql = "DELETE FROM carts WHERE item='Mexican Salad'";
                  ...
                  <?php
                      if(isset($_POST['add3']))
                      {
                        ...
                        else
                        {
                            ...
                            $sql = "INSERT INTO carts (name, item, price, quantity) VALUES ('name', 'Nachos', '125', '$qty3')";
                            if(mysqli_query($link, $sql))
                            {
                                echo "Records added successfully.";
                            } 
                  ...
                  <?php
                      if(isset($_POST['add4']))
                      {
                        ...
                        else
                        {
                            ...
                            $sql = "INSERT INTO carts (name, item, price, quantity) VALUES ('name', 'Veg Burger', '270', '$qty4')";
                            if(mysqli_query($link, $sql))
                            {
                                echo "Records added successfully.";
                            } 
                    ...
                    <?php
                        if(isset($_POST['del4']))
                      {
                        ...
                        {
                            $sql = "DELETE FROM carts WHERE item='Veg Burger'";
                  ...
                  <?php
                      if(isset($_POST['add5']))
                      {
                        ...
                        else
                        {
                            ...
                            $sql = "INSERT INTO carts (name, item, price, quantity) VALUES ('name', 'Veg Pizza', '250', '$qty5')";
                            if(mysqli_query($link, $sql))
                            {
                                echo "Records added successfully.";
                            } 
                    ...
                    <?php
                        if(isset($_POST['del5']))
                      {
                        ...
                        {
                            $sql = "DELETE FROM carts WHERE item='Veg Pizza'";
                  ...
                  <?php
                      if(isset($_POST['add6']))
                      {
                        ...
                        else
                        {
                            ...
                            $sql = "INSERT INTO carts (name, item, price, quantity) VALUES ('name', 'Margareta Pizza', '170', '$qty6')";
                            if(mysqli_query($link, $sql))
                            {
                                echo "Records added successfully.";
                            } 
                    ...
                    <?php
                        if(isset($_POST['del6']))
                      {
                        ...
                        {
                            $sql = "DELETE FROM carts WHERE item='Margareta Pizza'";
